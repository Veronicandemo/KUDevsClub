...
export default function Footer() {
  return (
    <>
      <div className="w-full min-h-min pt-20 flex items-center justify-center bg-black">
        <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
          <div className="w-full text-7xl font-bold">
            <h1 className="w-full text-xl md:text-7xl md:w-2/3">
              How can we help you. get in touch
            </h1>
          </div>
          <div className="flex mt-8 flex-col md:flex-row md:justify-between">
            <p className="w-full md:w-2/3 text-gray-400">
              Elevating Ideas, Elevating Careers - Where Tech Innovators Thrive!
              🚀🌐 Join us for hands-on coding projects, networking with
              industry pros, and the journey to tech excellence.
            </p>
          ...
          <div className="flex flex-col">
            <div className="flex mt-24 mb-12 items-center flex-row justify-between">
              <Image
                src="/logo-white-.png"
                width={200}
                height={200}
                className="hidden md:block"
                alt="Logo of KU developers club"
              />
              <Link
                href="/about"
            ...
            <p className="w-full text-center my-12 text-gray-600">
              Copyright © 2023 KU Developers Club
            </p>
          </div>
        </div>
      </div>
